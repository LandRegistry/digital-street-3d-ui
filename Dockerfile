...
RUN cd /supporting-files && curl -SLO "https://nodejs.org/dist/v10.15.3/node-v10.15.3-linux-x64.tar.xz" && \
tar -xJf "node-v10.15.3-linux-x64.tar.xz" -C /usr/local --strip-components=1 && \
