...
from digital_street_3d_ui.custom_extensions.gzip_static_assets.main import gzip_cache
from digital_street_3d_ui.custom_extensions.gzip_static_assets.main import gzip_cache_key
...
class TestGzipStaticAssets(unittest.TestCase):
    ...
    @mock.patch('digital_street_3d_ui.custom_extensions.gzip_static_assets.main.GzipStaticAssets.init_app')
    ...
    def test_gzipped_response(self):
        # Create test file
        filename = 'digital_street_3d_ui/assets/dist/gzip-test.css'
