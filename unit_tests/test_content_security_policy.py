...
from search_index_map_ui.custom_extensions.content_security_policy.main import ResponseWithoutCSP
...
class TestContentSecurityPolicy(unittest.TestCase):
    ...
    @mock.patch('search_index_map_ui.custom_extensions.content_security_policy.main.ContentSecurityPolicy.init_app')
    ...
    @mock.patch('search_index_map_ui.custom_extensions.content_security_policy.reporting.logger.error')
